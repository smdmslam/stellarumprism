...
### Grounded-Chat: protocol over prompting

Verification doesn't only belong to edits. It belongs to chat.
...
3. **Rule.** State the rule that maps evidence to answer.
4. **Working.** Show the breakdown. Numbers must add up.
