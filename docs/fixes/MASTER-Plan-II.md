...
- **Final default-on lineup (8 models):**
  - Main: `gpt-5.4`, `gemini-2.5-pro`, `gemini-2.5-flash-lite`, `gemini-2.5-flash`, `grok-4.1-fast`, `haiku`, `glm-5`
  - Explore: `qwen-235b`
...
- Final default-on set: gpt-5.4, gemini-2.5-pro, gemini-2.5-flash-lite, gemini-2.5-flash, grok-4.1-fast, haiku, glm-5, qwen-235b
